...
class window_update(QWidget):  # 增加更新页面（Check for Updates）
    ...
    def upd(self):
        webbrowser.open('https://github.com/Ryan-the-hito/Banana/releases')
        ...
        if AccountGPT != '':
            ...
            if list_dir != []:
                for i in range(len(list_dir)):
                    if 0 <= i <= 4:
                        ...
                        try:
                            ...
                            with open('todeletemidindex.txt', 'a', encoding='utf-8') as f0:
                                f0.write(tarnamecsv + '\n')
                            SUCC = 1
                        except Exception as e:
                            print(str(e) + 'part 1')
                ...
                if SUCC == 1:
                    ...
                    # remove
                    midindexde = codecs.open('todeletemidindex.txt', 'r', encoding='utf-8').read()
                    ...
                    if midindexde_list != []:
                        for i in range(len(midindexde_list)):
                            try:
                                ...
                                pass
                    with open('todeletemidindex.txt', 'w', encoding='utf-8') as f0:
                        f0.write('')
